// lib/stacks/issuance-mok-services-stack.ts
...
export interface IssuanceMokServicesStackProps extends CommonLambdaStackProps {
  arnIssuanceMokDocsBucket: string;
  arnAssitsbucketBucket: string;
}

export class IssuanceMokServicesStack extends cdk.Stack {
  public readonly issuanceMokServicesLambda: lambda.IFunction;
  public readonly arnIssuanceMokServicesLambda: string;

  constructor(scope: Construct, id: string, props: IssuanceMokServicesStackProps) {
    super(scope, id);
    ...
    const issuanceMokServicesLambda = lambdaCreator.createLambda(
      this,
      "IssuanceMokServicesFunction",
      props,
      "IssuanceMokServices",
      {
        volumes: [
    ...
    this.arnIssuanceMokServicesLambda =
      issuanceMokServicesLambda.functionArn;
  }
}