...
{
    public class EventFirstContactDto
    {
        ...
        public List<EmergencyContactCreatedDto>? ListEmergencyContactEvent { get; set; } = null;
        ...
        public string? NameEventProvider { get; set; }

        public string? TypeEventProvider { get; set; }
