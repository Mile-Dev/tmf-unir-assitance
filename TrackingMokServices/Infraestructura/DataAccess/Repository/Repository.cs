...
namespace TrackingMokServices.Infraestructura.DataAccess.Repository
{
    public class Repository<T>(MainContext context) : IRepository<T> where T : class
    {
        ...
        public async Task<T> UpdateAsync(T entity)
        {
            ...
            var existing = await _context.Set<T>().FindAsync(id) ?? throw new Exception("Event provider not found");
